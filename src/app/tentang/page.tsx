...
export const metadata: Metadata = {
  title: "Tentang Kami | Heksen Garage",
  description: "Profil bengkel Heksen Garage, spesialis perbaikan body dan restorasi mobil berpengalaman.",
};
    ...
    <>
      <Section className="bg-brand-dark pt-32 pb-16">
        <div className="text-center">
          <h1 className="mb-4 text-4xl font-extrabold md:text-5xl">Tentang Heksen Garage</h1>
      ...
      <Section className="bg-brand-black">
        <div className="mx-auto max-w-3xl text-brand-light prose prose-invert">
          <p className="mb-4">
            Heksen Garage adalah bengkel spesialis yang berfokus pada body repair, chassis repair, dan restorasi kendaraan. Kami mengerti bahwa kendaraan yang mengalami kecelakaan berat membutuhkan penanganan khusus agar kembali aman dan nyaman dikendarai.
          </p>
          <p>
